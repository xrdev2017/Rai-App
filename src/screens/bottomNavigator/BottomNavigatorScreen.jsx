...
import { Plus, Shirt, UserRound, Globe, Wand2 } from "lucide-react-native";
        ...
        >
          ...
          <View
            style={[
              ...
              {
                marginBottom: Platform.OS === "ios" ? insets.bottom + 130 : 150,
              },
            ]}
          >
            <View
            ...
            >
              {centralModalOption.map((item, i) => (
                ...
                >
                  <Text
                    style={[styles.modalText, { color: modalTextColor }]}
                  >{`${t(item?.title)}`}</Text>
                </Pressable>
              ))}
            </View>
            <View
              style={[styles.modalTriangle, { backgroundColor: modalBgColor }]}
            />
          </View>
        </Pressable>
      </Modal>
              ...
              screenOptions: {
                ...
                tabBarButton: (props) => (
                  <Pressable
                    {...props}
                    android_ripple={null}
                    style={[props.style, { flex: 1, zIndex: 1 }]}
                  />
                ),
              },
            })}
